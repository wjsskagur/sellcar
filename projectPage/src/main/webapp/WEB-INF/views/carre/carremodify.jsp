...
<div class="page-main-style">
	<h2>글수정</h2>
	<form:form action="update.do" enctype="multipart/form-data" commandName="carreVO">
		...
		<ul>
			...
			<li>
				...
				<c:if test="${!empty carreVO.filename}">
				<br>
				<span>(${carreVO.filename})파일이 등록되어 있습니다.다시 업로드하면 기존 파일은 삭제됩니다.</span>
				</c:if>
			</li>
		</ul>
		<div class="align-center">
			<input type="submit" value="수정">
			<input type="button" value="목록" onclick="location.href='carrelist.do'">	
		</div>
	</form:form>
</div>